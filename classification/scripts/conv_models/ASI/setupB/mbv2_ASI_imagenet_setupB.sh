...
python trainer_cls.py ${common_args} --logger.exp_name ASI_l2_k${k}_${usr_group_kl} --model.num_of_finetune 2 --model.budget 0.152898713946342
python trainer_cls.py ${common_args} --logger.exp_name ASI_l4_k${k}_${usr_group_kl} --model.num_of_finetune 4 --model.budget 0.732799172401428