...
python trainer_cls.py ${common_args} --logger.exp_name ASI_l2_k${k}_${usr_group_kl} --model.num_of_finetune 2 --model.budget 0.479902267456055
python trainer_cls.py ${common_args} --logger.exp_name ASI_l4_k${k}_${usr_group_kl} --model.num_of_finetune 4 --model.budget 0.87998229265213